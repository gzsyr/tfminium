...
if __name__ == '__main__':
    ...
    pytest.main(["-v",
                 ...
                 # 
                 # "./city/test_index_allcity_城市.py::TestAllcity::test_select_nj_选择南京",
                 # # 租房房源详情页
                 ...
                 # 
                 # "esf/test_esf_房源成交详情页.py::TestFangYuanChengjia::test_001_点击底部IM咨询",
                 # "esf/test_esf_房源成交详情页.py::TestFangYuanChengjia::test_002_点击咨询同小区在售",
                 # "esf/test_esf_房源成交详情页.py::TestFangYuanChengjia::test_003_点击咨询房源详细信息咨询",
