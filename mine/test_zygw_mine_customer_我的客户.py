...
class TestMineCustomer(TestMine):
    ...
    def test_03_切换到已回拨(self):
        ...
        V6.27.X: 切换到已回拨TAB
        """
        self.find_element('view[data-idx="2"]', inner_text='已回拨').tap()
    ...
    def test_04_切换到已拨已聊(self):
        ...
        V6.27.X: 切换到已拨已聊TAB
        """
        self.find_element('view[data-idx="3"]', inner_text='已拨已聊').tap()
    ...
    def test_12_筛选客户并重置(self):
        ...
        #     点击筛选项
        self.find_element('view[class="sonMenuCon"]', inner_text='已回拨').tap()
        ...
        self.get_screenshot("筛选（已回拨、有效、高）的结果")
    ...
    def add_comment(self, yx='高', lx='普通跟进', zt='有效', bz='test'):
        """
        添加跟进记录页面
        """
        self.delay(2)
    ...
    def test_20_客户详情_编辑客户(self):
        ...
        self.delay(2)
        self.verifyPageName('/page/business/infoManage/editCustomer')
    ...
    def test_22_客户详情_写跟进(self):
        ...
        self.verifyPageName('/page/business/infoManage/followAdd')
        self.get_screenshot('写跟进页面')

        self.add_comment(yx='无', lx='到访跟进', zt='无效', bz=time.strftime('%Y-%m-%d %H:%M:%S'))
    ...
    def test_23_客户详情_TAB切换(self):
        ...
        self.find_element('text', inner_text='资料').tap()
        self.get_screenshot('切换到“资料”')

        self.find_element('text', inner_text='轨迹').tap()
        self.get_screenshot('切换到“轨迹”')
