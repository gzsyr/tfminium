...
class TestNewsHouseList(minium.MiniTest):
    ...
    def test_click_search(self):
        ...
        :return:
        """
        ele = self.page.get_element("navigator[class='search-input']")
        ele.tap()
        print("search: ", ele)
        delay(2)
    ...
    def test_click_fx(self):
        ...
        :return:
        """
        ele = self.page.get_element("view[class='newHouseRfixed-share xfxq_fx']")
        ele.tap()
        print("fx: ", ele)
        delay(2)
    ...
    def test_click_housedetail(self):
        ...
        :return:
        """
        ele = self.page.get_elements("view[catchtap='goNewhouseDetail']")
        ele[0].tap()
    ...
    def test_show_wz(self):
        ...
        :return:
        """
        ele = self.page.get_element(inner_text="位置")
        ele.tap()
        print("wz: ", ele)
        delay(2)
    ...
    def test_show_jg(self):
        ...
        :return:
        """
        ele = self.page.get_element(inner_text="价格")
        ele.tap()
        print("jg: ", ele)
        delay(2)
    ...
    def test_show_hx(self):
        ...
        :return:
        """
        ele = self.page.get_element(inner_text="户型")
        ele.tap()
        print("hx: ", ele)
        delay(2)
    ...
    def test_show_sx(self):
        ...
        :return:
        """
        ele = self.page.get_element(inner_text="筛选")
        ele.tap()
        print("sx: ", ele)
        delay(2)
    ...
    def test_show_px(self):
        ...
        :return:
        """
        ele = self.page.get_element(inner_text="排序")
        ele.tap()
        print("px: ", ele)
        delay(2)
    ...
    def test_select_wz(self):
        ...
        ele = self.page.get_element(inner_text="位置")
        ele.tap()
        ele1 = self.page.get_element(inner_text="区域")
        ele1.tap()
        ele2 = self.page.get_element(inner_text="鼓楼区")
        ele2.tap()
    ...
    def test_select_jg(self):
        ...
        ele = self.page.get_element(inner_text="价格")
        ele.tap()
        ele1 = self.page.get_element(inner_text="25000-30000元/㎡")
        ele1.tap()
    ...
    def test_select_hx(self):
        ...
        ele = self.page.get_element(inner_text="户型")
        ele.tap()
        ele1 = self.page.get_element(inner_text="二室")
        ele1.tap()
    ...
    def test_select_sx(self):
        ...
        :return:
        """
        self.page.get_element(inner_text="筛选").ele.tap()
        self.page.get_element(inner_text="品牌房企").tap()
        self.page.get_element(inner_text="住宅").tap()
        self.page.get_element(inner_text="80-100㎡").tap()
        self.page.get_element(inner_text="六月内开盘").tap()
        self.page.get_element(inner_text="精装修").tap()
        ele = self.page.get_element("view[catchtap='newHouseMaskLi-sx-btn-confirm']")
        ele.tap()
        print("select_sx: ", ele)
        delay(2)
    ...
    def test_select_px(self):
        ...
        ele = self.page.get_element(inner_text="排序")
        ele.tap()
        ele1 = self.page.get_element(inner_text="开盘时间由近到远")
        ele1.tap()
